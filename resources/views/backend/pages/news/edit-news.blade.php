        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-newspaper-o"></i> Update News</h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form action="{{route('edit-news-action')}}" method="post"
                                          enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <input type="hidden" name="criteria" value="{{$newsData->id}}">

                                        <div class="form-group form-group-sm">
                                            <label for="title">Title</label>
                                            <input type="text" name="title" id="title" value="{{$newsData->title}}"
                                                   class="form-control">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <input type="text" readonly name="slug" value="{{$newsData->slug}}"
                                                   id="slug"
                                                   class="form-control">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <input type="text" name="keywords" id="keywords" data-role="tagsinput"
                                                       value="{{$newsData->meta_keywords}}" class="form-control">
                                            </div>
