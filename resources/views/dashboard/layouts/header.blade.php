...
<head>
    ...
    <link href="{{asset('assets/chat/custom.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('assets/backend/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}" rel="stylesheet">
    <link href="{{asset('assets/backend/imgzom/dist/css/jquery.pan.css')}}" rel="stylesheet">
